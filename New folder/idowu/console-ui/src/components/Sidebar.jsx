...
const categories = [
  "Management", "Compute", "Storage", "Analytics", "Networking", 
  "Distributed Cloud", "Serverless", "Databases", "Observability", 
  "Operations", "Security", "App Development", "CI/CD", 
  "Artificial Intelligence", "Integration Services", "Tools", 
  "Web3", "Other Google products", "Support"
];
...
const Sidebar = ({ 
  ...
  const sections = ['All Products', 'Jump Start Solutions', 'Solution deployments'];
    ...
    <div className="max-w-[277px] w-full border-r h-full flex flex-col">
      <div className="flex items-center gap-[20px] px-[20px] border-b-[1px] py-[5px] sticky top-0 bg-white z-10">
        <div className="cursor-pointer">
          <img width={30} height={30} src={ActivateCloudIcon} alt="ActivateCloudIcon" />
        </div>
        <h1 className="text-[20px] leading-[39px] text-[#707070] font-medium">Solutions</h1>
      </div>
        ...
        <div className="px-[10px] py-[5px] space-y-[20px]">
          <div className="pt-[10px] space-y-[10px]">
            {sections.map((section) => (
              ...
              >
                <h1 className="text-[14px] leading-[21px] font-medium">{section}</h1>
              </div>
            ))}
          </div>
          ...
          {categories.map((category) => (
            ...
            >
              <h1 className="text-[14px] leading-[21px] font-normal">{category}</h1>
            </div>
          ))}
        </div>
      </div>
